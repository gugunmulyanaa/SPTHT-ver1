    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <?php if(sizeof($listPenyakit)>0) { ?>
                <p>
                    Berdasarkan gejalanya, bonsai di prediksi mengidap penyakit <b><?php echo $dataHasil['nama'];?></b> dengan tingkat kepercayaan <b><?php echo $dataHasil['kepercayaan'];?> %</b><br/>
                    <?php echo $dataHasil['keterangan'];?>. <p style="font-style: bold; color: red; font-size: 13px;">*Hasil diagnosa ini masih membutuhkan pemeriksaan lebih lanjut.</p>
                </p>
            <?php }else{?>
                <p>
