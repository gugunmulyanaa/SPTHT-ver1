...
<html lang="en">
<head>
	<title>Login | Sistem Pakar Hama Dan Penyakit Tanaman Bonsai </title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<section class="login100-form validate-form">
					...
					<div class="w-full text-center p-t-27 p-b-239" >
						...
						<a href="https://soelaksono.com" target="_blank" class="txt2" style="color: #3EA8FF" style="font-family: arial">
							soelaksono
						</a>
					</div>
				...
				<div class="login100-more" style="background-image: url('<?php echo base_url() ?>assets/templatelogin/images/bonsai1.jpg');"></div>
			</div>
		</div>
	</div>
