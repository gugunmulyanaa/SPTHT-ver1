          ...
          <div class="left_col scroll-view" style="background: #fff">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo base_url() ?>assets/production/images/logo.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span style="color: #4B6277">SISTEM PAKAR</span>
                <h2 style="color: #4B6277">TANAMAN BONSAI</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" style="padding: 12px 28px 12px" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url() ?>assets/production/images/imglagi.jpg" alt="">SOELAKSONO
