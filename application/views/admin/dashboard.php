            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>SISTEM PAKAR <small>Diagnosa Hama Dan Penyakit Pada Tanaman Bonsai</small></h3>
                  </div>
                  <div class="col-md-6">
                    <div id="reportrange" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                      <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                      <span>December, 2019 - Juni, 2020</span> <b class="caret"></b>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-6">
                  <div class="x_title">
                    <span style="font-size: 14px;">Sistem Pakar ini berfungsi sebagai pendeteksi hama dan penyakit pada tanaman bonsai.</span>
